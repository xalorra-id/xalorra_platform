...
export default async function Blog({
  ...
  return (
    <main className="overflow-hidden">
      ...
      <Container>
        <Navbar />
        <Subheading className="mt-16">The Xalorra Chronicle</Subheading>
        <Heading as="h1" className="mt-2">
          Building the Future, Together.
        </Heading>
        <Lead className="mt-6 max-w-3xl">
          See how contributors from around the world are shaping the next generation of open AI workflows with Xalorra.
        </Lead>
      </Container>
